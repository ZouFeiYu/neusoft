	...
	<article class="cl pd-20">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<span class="label label-default radius">${thisAdmin.id}</span>
			</div>
		</div>
		<!-- nickName* -->
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<span class="label label-default radius">${thisAdmin.nickName}</span>
			</div>
		</div>
		<!-- passTip -->
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<span class="label label-default radius">${thisAdmin.passTip}</span>
			</div>
		</div>
		<!-- passTipKey -->
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<span class="label label-default radius">${thisAdmin.passTipKey}</span>
			</div>
		</div>
		<!-- name -->
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<span class="label label-default radius">${thisAdmin.name}</span>
			</div>
		</div>
		<!-- IdCard -->
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<span class="label label-default radius">${thisAdmin.idCard}</span>
			</div>
		</div>
		<!-- email -->
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<span class="label label-default radius">${thisAdmin.email}</span>
			</div>
		</div>
		<!-- phone -->
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<span class="label label-default radius">${thisAdmin.phone}</span>
			</div>
		</div>
		<!-- createdUser -->
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<span class="label label-default radius"> <fmt:formatDate
						...
						value="${thisAdmin.author.createdTime}" />
				</span>
			</div>
		</div>
		<!-- modifyUser -->
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<span class="label label-default radius"> <fmt:formatDate
						pattern="yyyy-MM-dd HH:mm:ss"
						value="${thisAdmin.author.modifyTime}" />
				</span>
			</div>
		</div>
		<div class="row cl">
