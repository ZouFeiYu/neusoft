...
<title>添加管理员 - 管理员管理 - 编辑管理员 - H-ui.admin v3.0</title>
<meta name="keywords"
		...
		<form action="#" method="post" class="form form-horizontal"
			...
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span
					class="c-red">&nbsp;*&nbsp;</span>管理员ID：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<span class="label label-default radius"> <input
						type="text" class="input-text" value="${thisAdmin.id}" id="id"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="${thisAdmin.nickName}" placeholder="管理员昵称"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="password" class="input-text" autocomplete="off"
						value="${thisAdmin.password}" placeholder="密码" id="password" name="password">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="password" class="input-text" autocomplete="off"
						placeholder="确认新密码" id="password2" name="password2" value="${thisAdmin.password}">
				</div>
			</div>
			<!-- passTip -->
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" autocomplete="off"
						placeholder="密码提示" id=passTip name="passTip" value="${thisAdmin.passTip}">
				</div>
			</div>
			<!-- passTipKey -->
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" autocomplete="off"
						placeholder="密码提示答案" id="passTipKey" name="passTipKey" value="${thisAdmin.passTipKey}">
				</div>
			</div>
			<!-- name -->
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" autocomplete="off"
						placeholder="真实姓名" id="name" name="name" value="${thisAdmin.name}">
				</div>
			</div>
			<!-- IdCard -->
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" autocomplete="off"
						placeholder="身份证号" id="IdCard" name="IdCard" value="${thisAdmin.idCard}">
				</div>
			</div>
			<!-- email -->
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" placeholder="@" name="email"
						id="email" value="${thisAdmin.email}">
				</div>
			</div>
			<!-- phone -->
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="${thisAdmin.phone}" placeholder=""
						id="phone" name="phone">
				</div>
			</div>
			<!-- <div class="row cl">
					...
					.validate(
							{
								...
								submitHandler : function(form) {
									...
									$(form)
											.ajaxSubmit(
													{
														url : '${pageContext.request.contextPath}/web/admin/updateAdminInfo',
														type : 'POST',
														//data:$(form).serialize(),
														dataType : "JSON",
														success : function(msg) {
															if (msg.code == 1) {
																...
																$(location)
																		.attr(
																				'href',
																				'${pageContext.request.contextPath}/web/admin/adminListPage');
															} else {
																layer.msg(msg.msg, {
																	icon : 5,
																	time : 3000
