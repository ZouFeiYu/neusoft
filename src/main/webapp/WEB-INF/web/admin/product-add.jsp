		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<span class="col-sm-2"><a href="javascript:;"
					onclick="upload_img(
					'添加分类',
					'${pageContext.request.contextPath }/web/test/_upload-img',
					null, null);" class="btn btn-danger radius"><i
						class="Hui-iconfont">&#xe6e2;</i> 选择图片</a> </span>
				<img alt="" src="${pageContext.request.contextPath}/images/temp/S-001.jpg" height="240px"/>
			</div>
		</div>
		<div class="row cl">
...
<jsp:include page="_upload-img.jsp"/>
</div>
<!--_footer 作为公共模版分离出去-->
