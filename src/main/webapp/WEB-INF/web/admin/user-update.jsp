...
<title>添加用户 - 用户管理 - H-ui.admin v3.0</title>
<meta name="keywords"
	...
	<article class="cl pd-20">
		<form action="#" method="post" class="form form-horizontal"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="${thisUser.nickName}" placeholder="用户昵称"
...
<%-- 			<!-- password* -->
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="password" class="input-text" autocomplete="off"
						value="${thisUser.password}" placeholder="密码" id="password" name="password">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="password" class="input-text" autocomplete="off"
						placeholder="确认新密码" id="password2" name="password2" value="${thisUser.password}">
				</div>
			</div> --%>
			<!-- passTip -->
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" autocomplete="off"
						placeholder="密码提示" id=passTip name="passTip" value="${thisUser.passTip}">
				</div>
			</div>
			<!-- passTipKey -->
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" autocomplete="off"
						placeholder="密码提示答案" id="passTipKey" name="passTipKey" value="${thisUser.passTipKey}">
				</div>
			</div>
			<!-- name -->
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" autocomplete="off"
						placeholder="真实姓名" id="name" name="name" value="${thisUser.name}">
				</div>
			</div>
			<!-- IdCard -->
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" autocomplete="off"
						placeholder="身份证号" id="IdCard" name="IdCard" value="${thisUser.idCard}">
				</div>
			</div>
			<!-- email -->
			<div class="row cl">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="${thisUser.phone}" placeholder=""
						id="phone" name="phone">
				</div>
			</div>
			<!-- <div class="row cl">
					...
					.validate(
							{
								...
								submitHandler : function(form) {
									...
									$(form)
											.ajaxSubmit(
													{
														url : '${pageContext.request.contextPath}/web/admin/updateUserInfo',
														type : 'POST',
														//data:$(form).serialize(),
														dataType : "JSON",
