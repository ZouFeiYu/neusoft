...
<body>
	<form action="#" method="post" class="form form-horizontal"
			id="form-category-add"onsubmit="return false">
	<article class="cl pd-20">
		<!-- nickName* -->
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span
				class="c-red">&nbsp;*&nbsp;</span>父类id：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${parentID }" placeholder="分类名称"
						readonly="no"id="parentId" name="parentId">
			</div>
		</div>
		<!-- nickName* -->
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="分类名称"
						id="name" name="name">
			</div>
		</div>
		<div class="row cl">
...
function add(){
	$.ajax({
		url:'${pageContext.request.contextPath}/web/admin/categoryAdd',
