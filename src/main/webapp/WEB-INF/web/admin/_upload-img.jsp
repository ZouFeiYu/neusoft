...
<!-- 		<button type="button" class="btn btn-primary"  data-toggle="modal" data-target="#avatar-modal" style="margin: 10px;">修改头像</button>
		...
		<div class=" fadev " id="avatar-modal" aria-hidden="true" aria-labelledby="avatar-modal-label" role="dialog" tabindex="-1">
		...
		<script src="${pageContext.request.contextPath}/head/html2canvas.min.js" type="text/javascript" charset="utf-8"></script>
