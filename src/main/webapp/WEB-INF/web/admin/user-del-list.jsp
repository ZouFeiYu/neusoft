				...
				<div class="cl pd-5 bg-1 bk-gray mt-20">
					<span class="l"><a href="javascript:;" onclick="datadel()"
						class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i>
							批量删除</a></span> <span class="r">共有数据：<strong>${userCount}</strong> 条
					</span>
				</div>
				<div class="mt-20">
							...
							<c:forEach items="${userList}" var="user">
								<tr class="text-c">
									...
									<a style="text-decoration: none"
											href="javascript:;" onClick="user_huanyuan(this,'${user.id}')"
											title="还原"><i class="Hui-iconfont">&#xe66b;</i></a> <a
											title="删除" href="javascript:;" onclick="user_del(this,'${user.id}')"
	...
	<script type="text/javascript">
		...
		function user_del(obj, id) {
			layer.confirm('确认要删除吗？(注意:此操作不可撤销!)', function(index) {
				$.ajax({
					url : '${pageContext.request.contextPath}/web/admin/deleteUser',
					type : 'POST',
					data : {'id' : id},
						dataType : "JSON",
